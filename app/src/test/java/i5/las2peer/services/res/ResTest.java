...
JSONObject object346860 = (JSONObject) response;
Assert.assertTrue(object346860.containsKey("id"));
Object object346860_2 = object346860.get("id");
Assert.assertTrue(object346860_2 instanceof Integer);
